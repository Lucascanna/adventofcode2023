...
const { computeNumberOfPossibleGames, computeFewestNumberOfCubes, day2 } = require('../day2.js')
...
tap.test('should return the fewest number of possible games', mainTest => {
  mainTest.test('possible game', t => {
    const input = 'Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green'
    const actual = computeFewestNumberOfCubes(input)
    const expected = {
      red: 4,
      green: 2,
      blue: 6
